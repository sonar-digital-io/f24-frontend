...
export function useUpdateLoadCases(loadGroupId: number) {
  ...
  return useMutation({
    ...
    onSuccess: (data) => queryClient.setQueryData(loadGroupKeys.loadCases(loadGroupId), data),
  });
}
...
export function useUpdateFatigueProfiles(loadGroupId: number) {
  ...
  return useMutation({
    ...
    onSuccess: (data) => queryClient.setQueryData(loadGroupKeys.fatigueProfiles(loadGroupId), data),
  });
}
