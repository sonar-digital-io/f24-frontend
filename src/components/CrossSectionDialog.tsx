...
function buildAllPts(m: number, p: number, t: number): [number, number][] {
 ...
 */
function offsetSvgPts(svgPts: [number, number][], offset: number): [number, number][] {
...
function computeArcFractions(svgPts: [number, number][]): number[] {
  const n = svgPts.length;
...
function perimeterLabel(frac: number, leFrac: number): string {
...
function chordLabel(pos: number): string {
...
function segD(pts: [number, number][]): string {
